...
class Ports:
    ...
    def editconfig_create_invalid_port_label(self, **kwargs):
        ...
        s = time.time()
        self.create_box('test_editconfig_create_invalid_port_label')
        xmlstr = self.create_xml_for_single_tag(
            'port-label', kwargs['port_labels'])
        result = self.edit_config_opr()
        gvn_port_ids = gvn_port_ids.split()
    ...
    def editconfig_create_invalid_port_state(self, **kwargs):
        ...
        s = time.time()
        self.create_box('test_editconfig_create_invalid_port_state')
        xmlstr = self.create_xml_for_single_tag(
            'port-state', kwargs['port_states'])
        gvn_port_ids = gvn_port_ids.split()
        result = self.edit_config_opr()
    ...
    def editconfig_create_invalid_lambda(self, **kwargs):
        ...
        s = time.time()
        self.create_box('test_editconfig_create_invalid_port_lambdas')
        xmlstr = self.create_xml_for_single_tag('lambda', kwargs['lambdas'])
        result = self.edit_config_opr()
        gvn_port_ids = gvn_port_ids.split()
        LOG.info('gvn_port_ids : %s' % gvn_port_ids)
    ...
    def editconfig_create_power_high_alarm(self, **kwargs):
        ...
        s = time.time()
        self.create_box(
            'test_editconfig_create_power-high-alarms for given port-ids')
        xmlstr = self.create_xml_for_single_tag(
            'power-high-alarm',
    ...
    def editconfig_create_invalid_power_high_alarm(self, **kwargs):
        ...
        s = time.time()
        self.create_box(
            'test_editconfig_create_invalid_power-high-alarms for given port-ids')
        xmlstr = self.create_xml_for_single_tag(
            'power-high-alarm',
            kwargs['power_high_alarms'])
        result = self.edit_config_opr()
    ...
    def editconfig_create_power_low_alarm(self, **kwargs):
        ...
        s = time.time()
        self.create_box(
            'test_editconfig_create_power_low_alarms_for_given_port_ids')
        xmlstr = self.create_xml_for_single_tag(
            'power-low-alarm',
    ...
    def editconfig_create_invalid_power_low_alarm(self, **kwargs):
        ...
        s = time.time()
        self.create_box(
            'test_editconfig_create_invalid_power_low_alarms_for_given_port_ids')
        xmlstr = self.create_xml_for_single_tag(
            'power-low-alarm',
            kwargs['power_low_alarms'])
        result = self.edit_config_opr()
    ...
    def editconfig_create_power_alarm_clear_holdoff(self, **kwargs):
        ...
        if result == 'PASS':
            ...
            csvOutput(
                'ports',
                'editconfig_creat_power_alarm_clear_holdoff',
                d,
                result)
        else:
            LOG.info('getting error from switch : FAIL\n\n')

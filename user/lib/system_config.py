...
class System_Config:
    ...
    def connect_switch(self, **kwargs):
        """ Connect switch.
            Arguments:
            host        : IP address.
            port        : Valid Port No.
    ...
    def editconfig_create_user_with_password_and_group(self, **kwargs):
        ...
        result, err = self.edit_config_opr()
    ...
    def editconfig_create_startup_mode_with_mode_preserve(self, **kwargs):
        ...
        nose.tools.assert_equals('PASS', result)
        nose.tools.assert_equals(kwargs['msg'], str(err))
        #nose.tools.assert_equals('RPC Reply OK', err)

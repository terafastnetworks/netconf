...
class test_user_oxc_opr:
    ...
    def test_user_get_oxc_for_single_ingress_port(self):
        """ testing get ingress port """
        self.oxc.get_ingress_ports(file_name='test_user_get_oxc_for_single_ingress_port.xml', ingress_ports=oxcDict['valid_ingress_ports'][0].split(','), egress_ports=oxcDict['valid_egress_ports'][0].split(','))

    def test_user_get_oxc_for_multiple_ingress_ports(self):
        """ testing get pairs """
        self.oxc.get_ingress_ports(
            file_name='test_user_get_oxc_for_multiple_ingress_ports.xml',
            ingress_ports=oxcDict['valid_ingress_ports'], egress_ports=oxcDict['valid_egress_ports'])

    def test_user_get_oxc_for_single_egress_port(self):
        """ testing get egress port """
        self.oxc.get_egress_ports(file_name='test_user_get_oxc_for_single_egress_port.xml', ingress_ports=oxcDict['valid_ingress_ports'][0].split(','),egress_ports=oxcDict['valid_egress_ports'][0].split(','))

    def test_user_get_oxc_for_multiple_egress_ports(self):
        """ testing get egress ports """
        self.oxc.get_egress_ports(
            file_name='test_user_get_oxc_for_multiple_egress_ports.xml', ingress_ports=oxcDict['valid_ingress_ports'], 
            egress_ports=oxcDict['valid_egress_ports'])

    def delete_oxc(self):
        """ Dlete all users """
        self.oxc.editconfig_delete_operation(
            file_name='test_user_delete_oxc_and_validate_with_get.xml',
            ingress_ports=oxcDict['valid_ingress_ports'],
            egress_ports=oxcDict['valid_egress_ports'], operation = 'get')
      
   
    def test_user_create_oxc_and_validate_with_get(self):
        ...
        self.oxc.editconfig_create_operation(
            file_name='test_user_create_oxc_and_validate_with_get.xml',
            ingress_ports=oxcDict['valid_ingress_ports'],
            egress_ports=oxcDict['valid_egress_ports'], operation = 'get')
        self.delete_oxc()

    def test_user_delete_oxc_and_validate_with_get(self):
    ...
    def test_user_replace_oxc_and_validate_with_get(self):
        ...
        self.oxc.editconfig_replace_operation(
            file_name='test_user_replace_oxc_and_validate_with_get.xml',
            ingress_ports=oxcDict['valid_ingress_ports'],
            egress_ports=egress_prts, operation = 'get')
        self.delete_oxc()


    def test_user_create_oxc_and_validate_with_get_config(self):
        """ testing editconfig_create_operation """
        self.oxc.cleanup_existing_connections(file_name='cleanup.xml')
        self.oxc.editconfig_create_operation(
            file_name='test_user_create_oxc_and_validate_with_get_config.xml',
            ingress_ports=oxcDict['valid_ingress_ports'],
            egress_ports=oxcDict['valid_egress_ports'], operation = 'get-config')
        self.delete_oxc()

    def test_user_delete_oxc_and_validate_with_get_config(self):
        """ testing editconfig_delete_operation """
        self.oxc.edit_config_create_oxc_without_opr(
            ingress_ports=oxcDict['valid_ingress_ports'],
            egress_ports=oxcDict['valid_egress_ports'])
        self.oxc.editconfig_delete_operation(
            file_name='test_user_delete_oxc_and_validate_with_get_config.xml',
            ingress_ports=oxcDict['valid_ingress_ports'],
            egress_ports=oxcDict['valid_egress_ports'], operation = 'get-config')

    def test_user_replace_oxc_and_validate_with_get_config(self):
        """ testing editconfig_replace_operation """
        self.oxc.cleanup_existing_connections(file_name='cleanup.xml')
        self.oxc.edit_config_create_oxc_without_opr(
            ingress_ports=oxcDict['valid_ingress_ports'],
        ...
        self.oxc.editconfig_replace_operation(
            file_name='test_user_replace_oxc_and_validate_with_get_config.xml',
            ingress_ports=oxcDict['valid_ingress_ports'],
            egress_ports=egress_prts, operation = 'get-config')
        self.delete_oxc()

    def test_user_create_oxc_with_invalid_ingress_ports(self):
        """ test_user_EditConfig_NegativeCase_With_IngressPort """

        self.oxc.cleanup_existing_connections(file_name='cleanup.xml')
        self.oxc.editconfig_negative_case_with_invalid_ingress_port(
            file_name='test_user_create_oxc_with_invalid_ingress_ports.xml',
            ingress_ports=oxcDict['invalid_ingress_ports'],
            egress_ports=oxcDict['valid_egress_ports'])

    def test_user_create_oxc_with_invalid_egress_ports(self):
        """ test_user_EditConfig_NegativeCase_With_EgressPort """

        self.oxc.cleanup_existing_connections(file_name='cleanup.xml')
        self.oxc.editconfig_negative_case_with_invalid_egress_port(
            file_name='test_user_create_oxc_with_invalid_egress_ports.xml',
            ingress_ports=oxcDict['valid_ingress_ports'],
            egress_ports=oxcDict['invalid_egress_ports'])

    def test_user_create_oxc_with_invalid_ingress_and_egress_ports(self):
        """ test_user_editconfig_negative_case_invalid_oxc_connection """

        self.oxc.cleanup_existing_connections(file_name='cleanup.xml')
        self.oxc.editconfig_negative_case_with_invalid_oxc_connection(
            file_name='test_user_create_oxc_with_invalid_ingress_and_egress_ports.xml',
            ingress_ports=oxcDict['invalid_ingress_ports'],
            egress_ports=oxcDict['invalid_egress_ports'])


    def test_user_get_oxc_for_invalid_ingress_port(self):
        """ testing get ingress port """
        self.oxc.get_oxc_using_invalid_ingress_port(
            file_name='test_user_get_oxc_for_invalid_ingress_port.xml',
            ingress_ports=str(oxcDict['invalid_ingress_ports'][0]).split(','), egress_ports=str(oxcDict['invalid_egress_ports'][0]).split(','))

    def test_user_get_oxc_for_invalid_ingress_port_using_text(self):
        """ testing get ingress port """
        self.oxc.get_oxc_using_invalid_ingress_port(
            file_name='test_user_get_oxc_for_invalid_ingress_port.xml',
    ...
    #def test_user_get_oxc_for_invalid_egress_port(self):
    #    """ testing get egress port """
    #    self.oxc.get_oxc_using_invalid_egress_port(
    #        file_name='test_user_get_oxc_for_invalid_egress_port.xml',
    #        ingress_ports=str(oxcDict['invalid_ingress_ports'][0]).split(','), egress_ports=str(oxcDict['invalid_egress_ports'][0]).split(','))

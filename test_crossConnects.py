...
class test_oxc_opr:
    ...
    def setUpClass(cls):
        ...
        cls.oxc.edit_config_create_oxc_without_opr(
    ...
    def testGetIngressPorts(self):
        ...
        self.oxc.get_ingress_ports(
            file_name='get_ingress_ports.xml',
            ingress_ports=oxcDict['valid_ingress_ports'])
    ...
    def testGetEgressPorts(self):
        ...
        self.oxc.get_egress_ports(
            file_name='get_egress_ports.xml',
            egress_ports=oxcDict['valid_egress_ports'])

    def testGetConfigCrossConnects(self):
        """ testing get-config crossconnects """
        self.oxc.getconfig_crossconnects(
            file_name='getconfig_crossconnects.xml')
    ...
    def testGetConfigIngressPorts(self):
        ...
        self.oxc.getconfig_ingress_ports(
            file_name='getconfig_ingress_ports.xml',
            ingress_ports=oxcDict['valid_ingress_ports'])
    ...
    def testGetConfigEgressPorts(self):
        ...
        self.oxc.getconfig_egress_ports(
            file_name='getconfig_egress_ports.xml',
            egress_ports=oxcDict['valid_egress_ports'])
    ...
    def test_EditConfigCreateOperation(self):
        ...
        self.oxc.editconfig_create_operation(
            file_name='editconfig_create_operation.xml',
            ingress_ports=oxcDict['valid_ingress_ports'],
            egress_ports=oxcDict['valid_egress_ports'])
    ...
    def test_EditConfigDeleteOperation(self):
        ...
        self.oxc.editconfig_delete_operation(
            file_name='editconfig_delete_operation.xml',
            ingress_ports=oxcDict['valid_ingress_ports'],
            egress_ports=oxcDict['valid_egress_ports'])
    ...
    def test_EditConfigReplaceOperation(self):
        ...
        self.oxc.editconfig_replace_operation(
            file_name='editconfig_replace_operation.xml',
            ingress_ports=oxcDict['valid_ingress_ports'],
            egress_ports=egress_prts)
    ...
    def test_EditConfig_NegativeCase_With_Invalid_IngressPort(self):
        ...
        self.oxc.editconfig_negative_case_with_invalid_ingress_port(
            file_name='editconfig_invalid_ingress_port.xml',
    ...
    def test_EditConfig_NegativeCase_With_Invalid_EgressPort(self):
        ...
        self.oxc.editconfig_negative_case_with_invalid_egress_port(
            file_name='editconfig_invalid_egress_port.xml',
            ingress_ports=oxcDict['valid_ingress_ports'],
    ...
    def test_EditConfig_NegativeCase_For_Invalid_Oxc_Connection(self):
        ...
        self.oxc.editconfig_negative_case_with_invalid_oxc_connection(
            file_name='editconfig_oxc_operation.xml',
            ingress_ports=oxcDict['invalid_ingress_ports'],
            egress_ports=oxcDict['invalid_egress_ports'])

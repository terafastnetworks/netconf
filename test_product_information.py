...
from lib.get_switch_ports_info_from_ports_range import get_valid_ingress_port, get_valid_egress_port
...
class test_product_information():
    ...
    def testGetManufacturer(self):
        ...
        self.Product_Information.get_manufacturer(
            ...
            file_name='get_manufacturer.xml')
    ...
    def testGetSerialNumber(self):
        ...
        self.Product_Information.get_serial_number(
            ...
            file_name='get_serial_number.xml')
    ...
    def testGetSoftwareVersion(self):
        ...
        self.Product_Information.get_software_version(
            ...
            file_name='get_software_version.xml')
    ...
    def testGetIngressPortsTypeInfo(self):
        ...
        self.Product_Information.get_ingress_ports_type_info(
            ...
            file_name='get_ingress_ports_type_info.xml')
    ...
    def testGetIngressPortsHasOpmInfo(self):
        ...
        self.Product_Information.get_ingress_ports_has_opm_info(
            ingress_port_ids=product_info_dict['ingress_port_ids'],
            file_name='get_ingress_ports_has_opm_info.xml')
    ...
    def testGetIngressPortsHasOxcInfo(self):
        ...
        self.Product_Information.get_ingress_ports_has_oxc_info(
            ingress_port_ids=product_info_dict['ingress_port_ids'],
            file_name='get_ingress_ports_has_oxc_info.xml')
    ...
    def testGetEgressPortsTypeInfo(self):
        ...
        self.Product_Information.get_egress_ports_type_info(
            ...
            file_name='get_egress_ports_type_info.xml')
    ...
    def testGetEgressPortsHasOpmInfo(self):
        ...
        self.Product_Information.get_egress_ports_has_opm_info(
            egress_port_ids=product_info_dict['egress_port_ids'],
            file_name='get_egress_ports_has_opm_info.xml')
    ...
    def testGetEgressPortsHasOxcInfo(self):
        ...
        self.Product_Information.get_egress_ports_has_oxc_info(
            egress_port_ids=product_info_dict['egress_port_ids'],
            file_name='get_egress_ports_has_oxc_info.xml')

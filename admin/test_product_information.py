...
class test_admin_product_information():
    ...
    def test_admin_get_software_version(self):
        ...
        self.Product_Information.get_software_version(
            ...
            file_name='test_admin_get_software_version.xml')

    def test_admin_get_ingress_ports_port_type(self):
        ...
        self.Product_Information.get_ingress_ports_type_info(
            ...
            file_name='test_admin_get_ingress_ports_port_type.xml')

    def test_admin_get_ingress_ports_has_opm(self):
        """ testing get ingress ports has opm info """

        self.Product_Information.get_ingress_ports_has_opm_info(
            ingress_port_ids=product_info_dict['ingress_port_ids'],
            file_name='test_admin_get_ingress_ports_has_opm.xml')

    def test_admin_get_ingress_ports_has_oxc(self):
        """ testing get ingress ports has oxc info """

        self.Product_Information.get_ingress_ports_has_oxc_info(
            ingress_port_ids=product_info_dict['ingress_port_ids'],
            file_name='test_admin_get_ingress_ports_has_oxc.xml')

    def test_admin_get_egress_ports_port_type(self):
        ...
        self.Product_Information.get_egress_ports_type_info(
            ...
            file_name='test_admin_get_egress_ports_port_type.xml')

    def test_admin_get_egress_ports_has_opm(self):
        """ testing get egress ports has opm info """

        self.Product_Information.get_egress_ports_has_opm_info(
            egress_port_ids=product_info_dict['egress_port_ids'],
            file_name='test_admin_get_egress_ports_has_opm.xml')

    def test_admin_get_egress_ports_has_oxc(self):
        """ testing get egress ports has oxc info """

        self.Product_Information.get_egress_ports_has_oxc_info(
            egress_port_ids=product_info_dict['egress_port_ids'],
            file_name='test_admin_get_egress_ports_has_oxc.xml')


    def test_admin_get_ingress_and_egress_ports_port_type(self):
        ...
        self.Product_Information.get_ingress_and_egress_ports_type_info(
            ...
            file_name='test_admin_get_ingress_and_egress_ports_port_type.xml')

    def test_admin_get_ingress_and_egress_ports_has_opm(self):
        """ testing get ingress and egress ports has opm info """

        self.Product_Information.get_egress_ports_has_opm_info(
            egress_port_ids=product_info_dict['port_ids'],
            file_name='test_admin_get_ingress_and_egress_ports_has_opm.xml')

    def test_admin_get_ingress_and_egress_ports_has_oxc(self):
        """ testing get ingress and egress ports has oxc info """

        self.Product_Information.get_egress_ports_has_oxc_info(
            egress_port_ids=product_info_dict['port_ids'],
            file_name='test_admin_get_ingress_and_egress_ports_has_oxc.xml')
